...
# behavioural measures were categorized as all being from the same domain (i.e., financial) instead
# of 4 domains (gambling, insurance, occupation, investment)
...
ma <- list(overall = read_csv(paste0(data_path, "cor_mat_convergent_overall_dat_beh_agg.csv")),
...
ggsave(paste0(output_path, "cor_matrix_fig_beh_agg.png"),
       plot = p,
       height = 30, 
       width = 45,
       units = "cm",
