...
shapley_list <- list(
  ...
  beh = read_csv(paste0(data_path, "shapley_values_multiv_beh.csv")),
  pro = read_csv(paste0(data_path, "shapley_values_multiv_pro.csv")),
  fre = read_csv(paste0(data_path, "shapley_values_multiv_fre.csv")))
# OMNIBUS -----------------------------------------------------------------
...
ggsave(plot = p,  paste0(output_path, "shapley_omni_multiverse.png"), height = 35,
