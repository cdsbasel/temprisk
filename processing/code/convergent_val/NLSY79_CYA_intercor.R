...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <- c("/Users/abagaini/Documents/TSRP/Data/NLSY79_CYA/ProcData/") # location of pre-processed panel data
intercor_data_wid_path <- c("/Users/abagaini/Documents/TSRP/Data/NLSY79_CYA/ProcData/") # intercor data with ids storage path
...
write_csv(intercor_df, file = paste0(intercor_data_path,sample,"_intercor_data.csv"))
write_rds(intercor2_df, file = paste0(intercor_data_wid_path,sample,"_intercor_data.rds"))
