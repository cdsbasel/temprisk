...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <-  c("~/Documents/TSRP/Data/LSVAW/ProcData/") # location of pre-processed panel data
intercor_data_wid_path <-  c("~/Documents/TSRP/Data/LSVAW/ProcData/") # intercor data with ids storage path
