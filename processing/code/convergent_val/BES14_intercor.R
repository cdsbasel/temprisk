...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <-  c("~/Documents/TSRP/Data/BES14/ProcData/") # location of pre-processed panel data
intercor_data_wid_path <-  c("~/Documents/TSRP/Data/BES14/ProcData/") # intercor data with ids storage path
