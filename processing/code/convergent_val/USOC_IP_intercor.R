...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <-  c("~/Documents/TSRP/Data/USOC_IP/ProcData/") # location of pre-processed panel data
intercor_data_wid_path <-  c("~/Documents/TSRP/Data/USOC_IP/ProcData/") # intercor data with ids storage path
