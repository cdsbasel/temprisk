...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <-  c("~/Documents/TSRP/Data/BBRS/ProcData/") # location of pre-processed panel data
intercor_data_wid_path <-  c("~/Documents/TSRP/Data/BBRS/ProcData/") # intercor data with ids storage path
