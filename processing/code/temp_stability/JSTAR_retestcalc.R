...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <-  c("/Volumes/usb_drive/ProcData/")# location of pre-processed panel data
retest_data_wid_path <- c("/Volumes/usb_drive/ProcData/") # retest data with ids storage path
