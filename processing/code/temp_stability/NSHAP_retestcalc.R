...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <- c("~/Documents/TSRP/Data/NSHAP/ProcData/") # location of pre-processed panel data
retest_data_wid_path <-c("~/Documents/TSRP/Data/NSHAP/ProcData/") # retest data with ids storage path
...
waves <- sort(unique(proc_data$wave_id)) # "1996-1997" "1998-1999" "2000-2001" "2003"     
retest2_df <- NULL
retest_df <- NULL
