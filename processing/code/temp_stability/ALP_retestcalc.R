...
# PATH INFORMATION ---------------------------------------------------
preproc_data_path <- c("~/Documents/TSRP/Data/ALP/ProcData/") # location of pre-processed panel data
retest_data_wid_path <- c("~/Documents/TSRP/Data/ALP/ProcData/") # retest data with ids storage path
...
waves <- proc_data %>% arrange(wave_year, wave_id) %>% select(wave_id)
waves <- unique(waves$wave_id)
# c("MS2","MS48",  "MS50",  "MS130", "MS133", "MS167", "MS169", "MS186", "MS189",
# "MS197","MS246", "MS260", "MS284", "MS342", "MS349", "MS315", "MS352", "MS472",
# "MS474")
