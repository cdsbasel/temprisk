...
panel <- "MIDUS"
sample <- "MIDUS_Project1"

# PATH INFORMATION ---------------------------------------------------
preproc_data_path <- c("~/Documents/TSRP/Data/MIDUS/ProcData/") # location of pre-processed panel data
retest_data_wid_path <-c("~/Documents/TSRP/Data/MIDUS/ProcData/") # retest data with ids storage path
