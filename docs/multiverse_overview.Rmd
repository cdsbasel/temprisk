...
<!-- ```{r, out.width="100%"} -->
<!-- knitr::include_graphics("images/threshold_plot.png") -->
<!-- ``` -->
...
<!-- ```{r, out.width="100%"} -->
<!-- knitr::include_graphics("images/threshold_agg_plot.png") -->
<!-- ``` -->
...
For the variance decomposition of the propensity and behavioural measures, we could not estimate Shapley values for certain datasets given that data certain points would be removed from the dataset,  and we would therefore encounter either issues to do with singularities or lack of levels in a categorical variable.
