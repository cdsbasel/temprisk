...
Below are step-by-step instructions on how to use the files in the [OSF repository](https://osf.io/5kzgd/) to replicate the analyses described in the [manuscript](https://psyarxiv.com/d7nuj/).
