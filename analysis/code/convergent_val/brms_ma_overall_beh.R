...
# Script reads the aggregated set of intercorrelations with a different categorization and 
# aggregation of behavioral measure (1 domain instead of 4 domains) and conducts three
# Bayesian meta-analyses/meta-regressions: 
# Omnibus
# By-Measure
# By-Domain
...
data_file <- "complete_agg_overall_beh_intercor_yb10.csv" # name of retest data 
...
write_rds(ma_fit, paste0(output_data_path, "fit_convergent_ma_overall_beh_agg", ".rds"))


# save output for plotting
ma_fit <- read_rds(paste0(output_data_path, "fit_convergent_ma_overall_beh_agg", ".rds"))
...
write_csv(melted_cormat, paste0(output_data_path, "cor_mat_convergent_overall_dat_beh_agg", ".csv"))
...
write_rds(ma_fit, paste0(output_data_path, "fit_convergent_ma_measure_beh_agg", ".rds"))


# save output for plotting

ma_fit <- read_rds(paste0(output_data_path, "fit_convergent_ma_measure_beh_agg", ".rds"))
...
write_csv(dt, paste0(output_data_path, "cor_mat_convergent_measure_dat_beh_agg", ".csv"))
...
write_rds(ma_fit, paste0(output_data_path, "fit_convergent_ma_domain_beh_agg", ".rds"))


# save output for plotting

ma_fit <- read_rds( paste0(output_data_path, "fit_convergent_ma_domain_beh_agg", ".rds"))
...
write_csv(dt, paste0(output_data_path, "cor_mat_convergent_domain_dat_beh_agg.csv"))
