...
data_w <- dat %>% 
  ...
  # remove certain domains because of lack of test-retest correlations 
  # filter(!domain_name %in% c("dri", "gam", "occ")) %>% 
...
saveRDS(fit_masc, paste0(output_data_path,"masc_fre.rds"))
