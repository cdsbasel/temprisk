...
# to different formats of data.  Focus on behavioural measures.
...
for (i in comb_select) {
  ...
  if (curr_prior_type == "vague") {
    priors <-
      ...
      prior(cauchy(0, 2), nlpar="logitrel", class = "sd")  +
  ...
  write_rds(list_multiv, paste0(output_data_path, "multiverse_fit_masc_beh.rds"))
