...
panel_data_path <- c("~/Documents/TSRP/Data/CMC/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/CMC/ProcData/") # where to save processed panel data
panel_name <- "CMC"
...
# dim(risk_info_analyse)  63 rows x  13 cols
