...
panel_data_path <- c("~/Documents/TSRP/Data/SAVE/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/SAVE/ProcData/") # where to save processed panel data
panel_name <- "SAVE"
