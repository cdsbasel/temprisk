...
panel_data_path <- c("~/Documents/TSRP/Data/ENKAVI/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/ENKAVI/ProcData/") # where to save processed panel data
panel_name <- "ENKAVI"
...
# dim(risk_info_analyse) 21 rows x 13 cols
