...
panel_data_path <- c("~/Documents/TSRP/Data/HRS/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/HRS/ProcData/") # where to save processed panel data
panel_name <- "HRS"
...
# dim(risk_info_analyse)  48 rows x  13 cols
