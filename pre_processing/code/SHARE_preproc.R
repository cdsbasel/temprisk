...
panel_data_path <- c("~/Documents/TSRP/Data/SHARE/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/SHARE/ProcData/") # where to save processed panel data
panel_name <- "SHARE"
...
# dim(risk_info_analyse)  14 rows x  13 cols
