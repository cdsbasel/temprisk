...
panel_data_path <- c("~/Documents/TSRP/Data/SOEP/RawData/CSV/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/SOEP/ProcData/") # where to save processed panel data
panel_name <- "SOEP"
...
# dim(risk_info_analyse)  17 rows x  13 cols
