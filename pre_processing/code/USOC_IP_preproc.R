...
panel_data_path <- c("~/Documents/TSRP/Data/USOC_IP/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/USOC_IP/ProcData/") # where to save processed panel data
panel_name <- "USOC_IP"
...
# dim(risk_info_analyse)  36 rows x  13 cols
