...
panel_data_path <- c("~/Documents/TSRP/Data/BES14/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/BES14/ProcData/") # where to save processed panel data
panel_name <- "BES14"
