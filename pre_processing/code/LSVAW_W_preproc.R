...
panel_data_path <- c("~/Documents/TSRP/Data/LSVAW/RawData/") # where the raw panel data is stored
preproc_data_path <- c("~/Documents/TSRP/Data/LSVAW/ProcData/") # where to save processed panel data
panel_name <- "LSVAW_W"
...
# reverse coding
main <- main %>% mutate(RISK_GEN_ORD5B =  6 - RISK_GEN_ORD5B)
